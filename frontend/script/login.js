    ...
    async handleLogin(e) {
        ...
        try {
            ...
            if (data.success) {
                ...
                console.log('Login: Dados recebidos do servidor:', data);
                
                // Criar objeto de sessão no formato esperado pelo route protection
                const sessionData = {
                ...
                console.log('Login: Dados de sessão criados:', sessionData);
                ...
                if (rememberMe) {
                    ...
                    console.log('Login: Dados salvos no sessionStorage');
                }
